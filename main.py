...
# %% print current items to verify if the transaction has been reset
print(trx1.check_order())
...
# %% test case 6: customer wants to update Eggs amount from 24 to 72 using update_item_amount method
